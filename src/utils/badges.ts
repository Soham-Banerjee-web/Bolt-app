import { Badge, User, UserSession } from '../types';
...
export class BadgeSystem {
  private static readonly BADGE_DEFINITIONS = [
    {
      ...
      condition: (user: User, sessions: UserSession[]) => sessions.length >= 1
    },
    {
      id: 'streak_3',
      name: '3-Day Streak',
    ...
    },
    {
      ...
      category: 'streak' as const,
      condition: (user: User) => user.streak >= 30
    },
    {
      id: 'sessions_10',
      name: 'Dedicated User',
      ...
      category: 'milestone' as const,
      condition: (user: User, sessions: UserSession[]) => sessions.length >= 10
    },
    {
      id: 'sessions_50',
      ...
      category: 'milestone' as const,
      condition: (user: User, sessions: UserSession[]) => sessions.length >= 50
    },
    {
      id: 'chat_explorer',
      name: 'Chat Explorer',
      ...
      condition: (user: User, sessions: UserSession[]) => 
  ...
  static checkAndAwardBadges(user: User, sessions: UserSession[]): Badge[] {
  ...
  static getBadgesByCategory(badges: Badge[]): Record<string, Badge[]> {
